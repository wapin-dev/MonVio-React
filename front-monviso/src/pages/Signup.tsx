...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || "Une erreur s'est produite lors de l'inscription. Veuillez réessayer.");
    } finally {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        <div className="bg-gradient-to-br from-gray-800/70 to-gray-900/70 backdrop-blur-md rounded-2xl border border-gray-700/50 shadow-2xl p-8 relative overflow-hidden">
          ...
          {error && (
            <div className="mb-4 p-3 bg-red-500/20 border border-red-500/50 rounded-xl text-red-200 text-sm relative z-10">
              {error}
            </div>
          )}
          {success && (
            <div className="mb-4 p-3 bg-green-500/20 border border-green-500/50 rounded-xl text-green-200 text-sm relative z-10">
              {success}
            </div>
          )}
          <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border-0 bg-gray-800/50 backdrop-blur-md py-2.5 px-4 text-gray-100 placeholder-gray-400 focus:ring-2 focus:ring-blue-500/50 shadow-lg shadow-black/10"
                ...
                <div className="mt-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    <div className="flex items-center text-xs">
                      ...
                      <span
                        className={password.length >= 8 ? 'text-gray-300' : 'text-gray-500'}
                      >
                        8+ caractères
                      </span>
                    </div>
                    <div className="flex items-center text-xs">
                      ...
                      <span
                        className={password.match(/[A-Z]/) ? 'text-gray-300' : 'text-gray-500'}
                      >
                        Majuscule
                      </span>
                    </div>
                    <div className="flex items-center text-xs">
                      ...
                      <span
                        className={password.match(/[0-9]/) ? 'text-gray-300' : 'text-gray-500'}
                      >
                        Chiffre
                      </span>
                    </div>
                    <div className="flex items-center text-xs">
                      ...
                      <span
                        className={password.match(/[^A-Za-z0-9]/) ? 'text-gray-300' : 'text-gray-500'}
                      >
                        Caractère spécial
                      </span>
                    </div>
            ...
            <button
              ...
              className={`w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl py-3 text-sm font-medium shadow-xl shadow-blue-700/20 transition-all ${
